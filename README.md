## Restaurant Review - Reactjs Project

### How to view the project in a browser

* Download project folder
* Navigate to project folder via the command line terminal
* Enter npm install
* Once installation complete enter npm start and the project will load up in your browser
